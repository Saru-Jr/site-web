...
public class Computer {
    ...
    public Computer(){
        ...
        Computerscore.setBackground(new Color(12,30,62));
        Computerscore.setForeground(new Color(252, 15, 245));
        Computerscore.setFont(new Font("MV BOLI", Font.PLAIN, 20));
        Computerscore.setText("Computer score : " + playerComputerScore );
        Computerscore.setOpaque(true);
        Computerscore.setBounds(10, 110, 200, 50);
        ...
        if (tile.getText()==""){
            currentPlayer=playerX;
                ...
                if(gameOver){ 
                    ...
                    }while(board[row][col].getText() !="" || gameOver);
                    switch (num) {
                        case 1: 
                        board[0][0].setText(playerComputer); 
                        checkWinner();
                        break;
                        case 2: 
                        board[0][1].setText(playerComputer); 
                        
                        checkWinner();
                        break;
                        case 3: 
                        board[0][2].setText(playerComputer); 
                        
                        checkWinner();
                        break;
                        case 4: 
                        board[1][0].setText(playerComputer); 
                        
                        checkWinner();
                        break;
                        case 5: 
                        board[1][1].setText(playerComputer); 
                        
                        checkWinner();
                        break;
                        case 6: 
                        board[1][2].setText(playerComputer); 
                        
                        checkWinner();
                        break;
                        case 7: 
                        board[2][0].setText(playerComputer); 
                        
                        checkWinner();
                        break;
                        case 8: 
                        board[2][1].setText(playerComputer); 
                        
                        checkWinner();
                        break;
                        case 9: 
                        board[2][2].setText(playerComputer); 
    ...
    protected void setWinner(JButton tile){
        ...
        }else if(currentPlayer==playerComputer){
            playerComputerScore++;
            Computerscore.setText("Computer Score : " + (playerComputerScore)/3);
        }  
    }
